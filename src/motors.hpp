...
MotorParameters wrist_motor{7, 0.19f, 6.9f * 1e-6f, 1.f, 5.0f, 0.004f, 0.004f}; // geared wrist motor. 
MotorParameters big_wrist_motor{7, 0.039f, 3.8f * 1e-6f, 1.5f, 5.0f, 0.008f, 0.008f};
